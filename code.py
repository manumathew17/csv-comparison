...
with open(r"C:\Users\manumathew\Desktop\fille.csv")as f:
    data=csv.reader(f)
    for row in  data:
         if int(row[31])>=starting_point and int(row[31])<=ending_point:
             with open(r"C:\Users\manumathew\Desktop\average.csv") as f3:
                data2=csv.reader(f3)
                for i in data2:
                         ...
                         if(row[3]==i[0]):
                             ...
                             with open(r"C:\Users\manumathew\Desktop\foutput8.csv","a",newline='' ) as f3:
                                 wtr = csv.writer(f3)
